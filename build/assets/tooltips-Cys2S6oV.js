...
function initTooltipsInside(root = document) {
  ...
  elements.forEach((el) => {
    ...
    tippy(el, {
      ...
      zIndex: 4,
      ignoreAttributes: false,
      arrow: hasBorder ? ROUND_ARROW + ROUND_ARROW : ROUND_ARROW,
      appendTo: (ref) => ref.parentElement,
      onCreate(instance) {
        const reference2 = instance.reference;
        const box = instance.popper.querySelector(".tippy-box");
        const scheme = reference2.getAttribute("data-color-scheme");
        if (scheme) {
